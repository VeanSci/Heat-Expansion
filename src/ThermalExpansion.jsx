...
/* ---------- 물질 아이콘 (플라스틱만 생수병 SVG, 나머지는 이모지) ---------- */
function MatIcon({ mat, size = 28 }) {
  if (mat.id === "plastic") {
    return (
      <svg width={size} height={size} viewBox="0 0 120 130" style={{ display: "inline-block", verticalAlign: "middle" }}>
        <g stroke="#1f5f8b" strokeWidth="4" strokeLinejoin="round" fill="#cfe3f2">
          <rect x="50" y="12" width="20" height="12" rx="2" fill="#bcd6ec" />
          <rect x="52" y="22" width="16" height="10" fill="#cfe3f2" />
          <path d="M52 32 L40 50 Q38 54 38 60 L38 110 Q38 116 44 116 L76 116 Q82 116 82 110 L82 60 Q82 54 80 50 L68 32 Z" />
        </g>
        <g stroke="#1f5f8b" strokeWidth="3" opacity="0.7">
          <line x1="40" y1="70" x2="80" y2="70" />
          <line x1="40" y1="84" x2="80" y2="84" />
          <line x1="40" y1="98" x2="80" y2="98" />
        </g>
      </svg>
    );
  }
  if (mat.id === "aluminum") {
    return (
      <svg width={size} height={size} viewBox="0 0 120 130" style={{ display: "inline-block", verticalAlign: "middle" }}>
        <g stroke="#1f5f8b" strokeWidth="4" strokeLinejoin="round" fill="#cfe3f2">
          <rect x="42" y="40" width="36" height="76" rx="6" />
          <rect x="44" y="34" width="32" height="8" rx="3" fill="#bcd6ec" />
        </g>
        <ellipse cx="66" cy="30" rx="6" ry="4" stroke="#1f5f8b" strokeWidth="3" fill="none" />
      </svg>
    );
  }
  return <span style={{ fontSize: size, lineHeight: 1 }}>{mat.icon}</span>;
}
        ...
        <Panel>
          <div style={{ fontSize: 14, lineHeight: 1.9 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              🪨 물질: {mat ? <><MatIcon mat={mat} size={18} /><b>{mat.name}</b></> : <b>-</b>}
            </div>
        ...
        <Panel>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            {SOLIDS.map((s) => (
              ...
              >
                <div style={{ fontSize: 20 }}><MatIcon mat={s} size={20} /></div>
                {s.name}
              </div>
            ))}
          </div>
